          ...
          <div class="card">
            <div class="card-body p-2">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Search</p>
                        <div class="mb-1">
                            <input type="text" class="form-control" placeholder="Enter name to search" aria-label="nake" aria-describedby="email-addon" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        </div>
                  </div>
                </div>
                <div class="col-4 text-end">
                          ...
                          @foreach ( $donations as $donation)
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <button class="btn btn-link text-dark text-sm mb-0 px-0 ms-4"><i class="fas fa-file-pdf text-lg me-1" aria-hidden="true"></i> Print</button>
                                </td>
                            </tr>
                        @endforeach
                      </tbody>
